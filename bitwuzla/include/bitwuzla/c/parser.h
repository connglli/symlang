 ...
 */
BitwuzlaParser *bitwuzla_parser_new(
    BitwuzlaTermManager *tm, BitwuzlaOptions *options, const char *language, uint8_t base,
 ...
 *       "commands" as in SMT2).
 */
void bitwuzla_parser_parse(
    BitwuzlaParser *parser, const char *input, bool parse_only, bool parse_file,
 ...
 */
BitwuzlaTerm
bitwuzla_parser_parse_term(BitwuzlaParser *parser, const char *input, const char **error_msg);
/**
 ...
 */
BitwuzlaSort
bitwuzla_parser_parse_sort(BitwuzlaParser *parser, const char *input, const char **error_msg);

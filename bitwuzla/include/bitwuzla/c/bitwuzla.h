 ...
 */
void bitwuzla_set_option_string(BitwuzlaOptions *options, BitwuzlaOption option, const char *val);
 ...
 */
const char *bitwuzla_get_option_string(BitwuzlaOptions *options, BitwuzlaOption option);
 ...
 *   * `BitwuzlaOptionInfo`
 */
void bitwuzla_get_option_info(
    BitwuzlaOptions *options, BitwuzlaOption option, BitwuzlaOptionInfo *info
);
 ...
 */
void bitwuzla_term_value_get_fp_ieee(
    BitwuzlaTerm term, const char **sign, const char **exponent, const char **significand,
    uint8_t base
);
 ...
 *       component bit-vector values defaults to binary format.
 */
void bitwuzla_print_unsat_core(Bitwuzla *bitwuzla, const char *format, FILE *file, uint8_t base);
 ...
 */
void bitwuzla_get_statistics(
    Bitwuzla *bitwuzla, const char ***keys, const char ***values, size_t *size
);
 ...
 */
BitwuzlaSort
bitwuzla_mk_array_sort(BitwuzlaTermManager *tm, BitwuzlaSort index, BitwuzlaSort element);
 ...
 */
BitwuzlaSort bitwuzla_mk_fun_sort(
    BitwuzlaTermManager *tm, uint64_t arity, BitwuzlaSort domain[], BitwuzlaSort codomain
);
 ...
 */
BitwuzlaTerm
bitwuzla_mk_bv_value(BitwuzlaTermManager *tm, BitwuzlaSort sort, const char *value, uint8_t base);
 ...
 */
BitwuzlaTerm
bitwuzla_mk_bv_value_uint64(BitwuzlaTermManager *tm, BitwuzlaSort sort, uint64_t value);
...
BitwuzlaTerm bitwuzla_mk_fp_value(
    BitwuzlaTermManager *tm, BitwuzlaTerm bv_sign, BitwuzlaTerm bv_exponent,
...
BitwuzlaTerm bitwuzla_mk_fp_from_real(
    BitwuzlaTermManager *tm, BitwuzlaSort sort, BitwuzlaTerm rm, const char *real
);
...
BitwuzlaTerm bitwuzla_mk_fp_from_rational(
    BitwuzlaTermManager *tm, BitwuzlaSort sort, BitwuzlaTerm rm, const char *num, const char *den
);
 ...
 */
BitwuzlaTerm
bitwuzla_mk_term2(BitwuzlaTermManager *tm, BitwuzlaKind kind, BitwuzlaTerm arg0, BitwuzlaTerm arg1);
 ...
 *   * `BitwuzlaKind`
 */
BitwuzlaTerm bitwuzla_mk_term3(
    BitwuzlaTermManager *tm, BitwuzlaKind kind, BitwuzlaTerm arg0, BitwuzlaTerm arg1,
    BitwuzlaTerm arg2
);
 ...
 */
BitwuzlaTerm
bitwuzla_mk_term(BitwuzlaTermManager *tm, BitwuzlaKind kind, uint32_t argc, BitwuzlaTerm args[]);
 ...
 *   * `BitwuzlaKind`
 */
BitwuzlaTerm bitwuzla_mk_term1_indexed1(
    BitwuzlaTermManager *tm, BitwuzlaKind kind, BitwuzlaTerm arg, uint64_t idx
);
 ...
 *   * `BitwuzlaKind`
 */
BitwuzlaTerm bitwuzla_mk_term1_indexed2(
    BitwuzlaTermManager *tm, BitwuzlaKind kind, BitwuzlaTerm arg, uint64_t idx0, uint64_t idx1
);
 ...
 *   * `BitwuzlaKind`
 */
BitwuzlaTerm bitwuzla_mk_term2_indexed1(
    BitwuzlaTermManager *tm, BitwuzlaKind kind, BitwuzlaTerm arg0, BitwuzlaTerm arg1, uint64_t idx
);
 ...
 *   * `BitwuzlaKind`
 */
BitwuzlaTerm bitwuzla_mk_term2_indexed2(
    BitwuzlaTermManager *tm, BitwuzlaKind kind, BitwuzlaTerm arg0, BitwuzlaTerm arg1, uint64_t idx0,
    uint64_t idx1
);
 ...
 *   * `BitwuzlaKind`
 */
BitwuzlaTerm bitwuzla_mk_term_indexed(
    BitwuzlaTermManager *tm, BitwuzlaKind kind, uint32_t argc, BitwuzlaTerm args[], uint32_t idxc,
    const uint64_t idxs[]
);
 ...
 */
BitwuzlaTerm
bitwuzla_mk_const_array(BitwuzlaTermManager *tm, BitwuzlaSort sort, BitwuzlaTerm value);
...
BitwuzlaTerm bitwuzla_substitute_term(
    BitwuzlaTerm term, size_t map_size, BitwuzlaTerm map_keys[], BitwuzlaTerm map_values[]
);
 ...
 * @param map_values The mapped values.
 */
void bitwuzla_substitute_terms(
    size_t terms_size, BitwuzlaTerm terms[], size_t map_size, BitwuzlaTerm map_keys[],

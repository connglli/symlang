...
#if (!defined(BITWUZLA_API_USE_C_ENUMS) && !defined(BITWUZLA_API_ENUM_CPP_H_INCLUDED)) ||          \
    (defined(BITWUZLA_API_USE_C_ENUMS) && !defined(BITWUZLA_API_ENUM_C_H_INCLUDED))
...
#define EVALUE(name) BITWUZLA_KIND_##name
  ...
  enum ENUM(Kind) {
     ...
     */
    EVALUE(FP_TO_UBV),
#if (!defined(NDEBUG) || defined(BITWUZLA_API_USE_C_ENUMS) || defined(BZLA_ENABLE_UNIT_TESTING))
#ifndef DOXYGEN_SKIP
    EVALUE(NUM_KINDS),
#endif
#endif

...
#if (!defined(BITWUZLA_API_USE_C_ENUMS) && !defined(BITWUZLA_API_OPTION_CPP_H_INCLUDED)) ||        \
    (defined(BITWUZLA_API_USE_C_ENUMS) && !defined(BITWUZLA_API_OPTION_C_H_INCLUDED))

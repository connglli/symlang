...
bool Lexer::isIdentStart(char c) { return std::isalpha(static_cast<unsigned char>(c)) || c == '_'; }

bool Lexer::isIdentCont(char c) { return std::isalnum(static_cast<unsigned char>(c)) || c == '_'; }
